...
export enum CategoriaProducto {
  AUDIFONO = 'Audifono',
  ANTEOJOS_RECETA = 'Anteojos Receta',
  ANTEOJOS_SOL = 'Anteojos Sol',
...
export const productos: Producto[] = [
  {
    ...
    categoria: CategoriaProducto.ANTEOJOS_SOL,
    precio: 25000.0,
    stock: 20,
  ...
  },
  {
    ...
    categoria: CategoriaProducto.ANTEOJOS_RECETA,
    precio: 18000.0,
    stock: 25,
  ...
  },
  {
    ...
    categoria: CategoriaProducto.AUDIFONO,
    precio: 75000.0,
    stock: 10,
