...
const redirectReceta = (receta: {
  ...
  router.push(
    `/recetas/${currentCliente.value?.id}?tab=${tab}&recetaId=${receta.id}`
  );
};
</script>
          ...
          >
            <div class="flex flex-row justify-between">
              ...
              <Button
                variant="outline"
                type="button"
                @click="router.push(`/ventas/new?cliente=${currentCliente.id}`)"
              >
                Nueva Venta
              </Button>
            </div>
              ...
              <div v-for="mov in ctaCorriente.movimientos">
                ...
                >
                  <div class="flex flex-row justify-start items-center">
                    ...
                    >
                    <Label class="w-[15rem] text-xs flex justify-start"
  ...
  <div class="page" v-else>
    ...
    <div class="pt-2 mb-4">
      <div class="flex flex-col justify-between items-start px-[5rem]">
        <div class="w-full">
          <h3 class="page-subtitle text-center">
            Cliente con id={{ route.params.id }} no encontrado
          </h3>
        </div>
      </div>
    </div>
