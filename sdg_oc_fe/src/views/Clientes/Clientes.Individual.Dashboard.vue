...
const loadData = async () => {
  ...
  try {
    ...
    console.log(ctaCorriente.value);
  } catch (err: any) {
...
const printComprobante = async (
  ...
  try {
    ...
    }_${date.toISOString().split("T")[0]}.pdf`;
  ...
  try {
    ...
    const newFactura = {
      ...
      tipoComprobante: tipoFactura(
        Number(currentCliente.value.categoriaFiscal)
      ),
...
<template>
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col justify-center">
            ...
            <div
              class="flex flex-row mt-3 justify-start items-center h-[1rem] text-gray-700"
            >
              ...
              <div v-if="currentCliente.clienteObrasSociales.length">
                <Badge
                  ...
                  variant="outline"
                  class="font-normal border-gray-700 mr-3 py-1"
  ...
  <Dialog v-model:open="openDialogClosedCaja">
    ...
    >
      ...
      <Button @click="openDialogClosedCaja = false" type="button"
        >Aceptar</Button
      >
    </DialogContent>
  </Dialog>
