...
import { condicionIvaDisplay, tipoComprobanteDisplay, tipoFactura } from '@/lib/utils';
              ...
              <div v-for="venta in ventasCliente">
                ...
                >
                  ...
                  <div class="flex flex-row p-0 justify-end  r-0">
                    ...
                    <Button v-if="!venta.factura" variant="ghost" type="button" @click="handleEmitFactura(venta)" class="text-xs  px-2 underline">
                      Emitir Factura
                    </Button>
                    <Button
                      v-if="
